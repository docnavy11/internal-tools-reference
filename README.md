...
Status: phases 1 to 5 of 7 implemented (skeleton; auth, permissions, shell, users admin; CRUD kit, audit, customers example; jobs, schedules, CSV import; files, email, Slack, notes). See `docs/BUILD_PLAN.md`.
